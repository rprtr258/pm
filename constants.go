...
//   PREFIX_MSG_INFO         = chalk.New(chalk.FgCyan).Sprint("[PM2][INFO] ")
//   PREFIX_MSG_ERR          = chalk.New(chalk.FgRed).Sprint("[PM2][ERROR] ")
//   PREFIX_MSG_MOD          = chalk.New(chalk.FgGreen, chalk.Bold).Sprint("[PM2][Module] ")
//   PREFIX_MSG_MOD_ERR      = chalk.New(chalk.FgRed).Sprint("[PM2][Module][ERROR] ")
//   PREFIX_MSG_WARNING      = chalk.New(chalk.FgYellow).Sprint("[PM2][WARN] ")
//   PREFIX_MSG_SUCCESS      = chalk.New(chalk.FgCyan).Sprint("[PM2] ")
...
//   IS_WINDOWS              = process.platform == "win32" || process.platform == "win64" || process.env.OSTYPE=="msys"||process.env.OSTYPE=="cygwin"
