    ...
    ["main", {role: "presentation"},
      ["aside", {id: "__sidebar", class: "sidebar", role: "none"},
        ["div", {class: "sidebar-nav", role: "navigation", "aria-label": "primary"},
          ["ul", {},
            ["li", {}, ["a", {class: "section-link", href: "#installation", title: "Installation"}, "Installation"]],
            ["ul", {},
              ["li", {}, ["a", {class: "section-link", href: "#systemd-service", title: "Systemd service"}, "Systemd service"]],
            ],
            ["li", {}, ["a", {class: "section-link", href: "#configuration", title: "Configuration"}, "Configuration"]],
            ["li", {}, ["a", {class: "section-link", href: "#usage", title: "Usage"}, "Usage"]],
            ["ul", {},
              ["li", ["a", {class: "section-link", href: "#run-process", title: "Run process"}, "Run process"]],
              ["li", ["a", {class: "section-link", href: "#list-processes", title: "List processes"}, "List processes"]],
              ["li", ["a", {class: "section-link", href: "#start-processes-that-already-has-been-added", title: "Start processes that already has been added"}, "Start processes that already has been added"]],
              ["li", ["a", {class: "section-link", href: "#stop-processes", title: "Stop processes"}, "Stop processes"]],
              ["li", ["a", {class: "section-link", href: "#delete-processes", title: "Delete processes"}, "Delete processes"]],
            ],
            ["li", ["a", {class: "section-link", href: "#process-state-diagram", title: "Process state diagram"}, "Process state diagram"]],
            ["li", ["a", {class: "section-link", href: "#development", title: "Development"}, "Development"]],
            ["ul", {},
              ["li", ["a", {class: "section-link", href: "#architecture", title: "Architecture"}, "Architecture"]],
              ["li", ["a", {class: "section-link", href: "#pm-directory-structure", title: "PM directory structure"}, "PM directory structure"]],
              ["li", ["a", {class: "section-link", href: "#differences-from-pm2", title: "Differences from pm2"}, "Differences from pm2"]],
              ["li", ["a", {class: "section-link", href: "#release", title: "Release"}, "Release"]],
            ],
          ],
        ],
      ],
      ["section", {class: "content"},
        ["article", {id: "main", class: "markdown-section", role: "main", tabindex: "-1"},
          ["h1", {id: "pm-process-manager", tabindex: "-1"}, ["a", {href: "#pm-process-manager", class: "anchor"}, ["span", {}, "PM (process manager)"]]],
          ["div", {}, ["a", {href: "https://github.com/rprtr258/pm"}, ["img", {src: "https://img.shields.io/badge/source-code?logo=github&label=github"}]]],
          ["h2", {id: "installation", tabindex: "-1"}, ["a", {href: "#installation", class: "anchor"}, ["span", {}, "Installation"]]],
          ["p", {}, "PM is available only for linux due to heavy usage of linux mechanisms. Go to the ", ["a", {href: "https://github.com/rprtr258/pm/releases/latest", target: "_top"}, "releases"], " page to download the latest binary."],
          ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
            ["span", {class: "token comment"}, "# download binary"], "\n",
            ["span", {class: "token function"}, "wget "], "https://github.com/rprtr258/pm/releases/latest/download/pm_linux_amd64", "\n",
            ["span", {class: "token comment"}, "# make binary executable"], "\n",
            ["span", {class: "token function"}, "chmod "], "+x pm_linux_amd64", "\n",
            ["span", {class: "token comment"}, "# move binary to $PATH, here just local"], "\n",
            ["span", {class: "token function"}, "mv "], "pm_linux_amd64 pm"],
          ],
            ["h3", {id: "systemd-service", tabindex: "-1"}, ["a", {href: "#systemd-service", class: "anchor"}, ["span", {}, "Systemd service"]]],
            ["p", {}, "To enable running processes on system startup:"],
            ["ul", {},
              ["li", {}, "Copy", ["a", {href: "#/pm.service"}, code("pm.service")], "file locally. This is the systemd service file that tells systemd how to manage your application."],
              ["li", {}, "Change", code("User"), "field to your own username. This specifies under which user account the service will run, which affects permissions and environment."],
              ["li", {}, "Change", code("ExecStart"), "to use", code("pm"), "binary installed. This is the command that systemd will execute to start your service."],
              ["li", {}, "Move the file to", code("/etc/systemd/system/pm.service"), "and set root permissions on it:"],
            ],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              ["span", {class: "token comment"}, "# copy service file to system's directory for systemd services"], "\n",
              ["span", {class: "token function"}, "sudo"], " ", ["span", {class: "token function"}, "cp"], " pm.service /etc/systemd/system/pm.service", "\n",
              ["span", {class: "token comment"}, "# set permission of service file to be readable and writable by owner, and readable by others"], "\n",
              ["span", {class: "token function"}, "sudo"], " ", ["span", {class: "token function"}, "chmod"], " ", ["span", {class: "token number"}, "644"], "/etc/systemd/system/pm.service", "\n",
              ["span", {class: "token comment"}, "# change owner and group of service file to root, ensuring that it is managed by system administrator"], "\n",
              ["span", {class: "token function"}, "sudo"], " ", ["span", {class: "token function"}, "chown"], " root:root /etc/systemd/system/pm.service", "\n",
              ["span", {class: "token comment"}, "# reload systemd manager configuration, scanning for new or changed units"], "\n",
              ["span", {class: "token function"}, "sudo"], " systemctl daemon-reload", "\n",
              ["span", {class: "token comment"}, "# enables service to start at boot time"], "\n",
              ["span", {class: "token function"}, "sudo"], " systemctl ", ["span", {class: "token builtin class-name"}, "enable"], " pm", "\n",
              ["span", {class: "token comment"}, "# starts service immediately"], "\n",
              ["span", {class: "token function"}, "sudo"], " systemctl start pm", "\n",
              ["span", {class: "token comment"}, "# soft link /usr/bin/pm binary to whenever it is installed"], "\n",
              ["span", {class: "token function"}, "sudo"], " ", ["span", {class: "token function"}, "ln"], " ", ["span", {class: "token parameter variable"}, "-s"], " ~/go/bin/pm /usr/bin/pm",
            ]],
            ["p", {}, "After these commands, processes with", code("startup: true"), "config option will be started on system startup."],

          ["h2", {id: "configuration", tabindex: "-1"}, ["a", {href: "#configuration", class: "anchor"}, ["span", {}, "Configuration"]]],
            ["p", {}, ["a", {href: "https://jsonnet.org/", target: "_top"}, "jsonnet"], " configuration language is used. It is also fully compatible with plain JSON, so you can write JSON instead."],
            ["p", {}, "See ", ["a", {href: "#/config.jsonnet"}, "example configuration file"], ". Other examples can be found in ", ["a", {href: "#/tests"}, "tests"], " directory."],

          ["h2", {id: "usage", tabindex: "-1"}, ["a", {href: "#usage", "data-id": "usage", class: "anchor"}, ["span", {}, "Usage"]]],
          ["p", {}, "Most fresh usage descriptions can be seen using", code("pm &lt;command&gt; --help"), "."],
            ["h3", {id: "run-process", tabindex: "-1"}, ["a", {href: "#run-process", "data-id": "run-process", class: "anchor"}, ["span", {}, "Run process"]]],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              ["span", {class: "token comment"}, "# run process using command"], "\n",
              "pm run go run main.go", "\n",
              "", "\n",
              ["span", {class: "token comment"}, "# run processes from config file"], "\n",
              "pm run ", ["span", {class: "token parameter variable"}, "--config"], " config.jsonnet",
            ]],
            ["h3", {id: "list-processes", tabindex: "-1"}, ["a", {href: "#list-processes", "data-id": "list-processes", class: "anchor"}, ["span", {}, "List processes"]]],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              "pm list",
            ]],

            ["h3", {id: "start-processes-that-already-has-been-added", tabindex: "-1"}, ["a", {href: "#start-processes-that-already-has-been-added", "data-id": "start-processes-that-already-has-been-added", class: "anchor"}, ["span", "Start processes that already has been added"]]],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              "pm start ", ["span", {class: "token punctuation"}, "["], "ID/NAME/TAG", ["span", {class: "token punctuation"}, "]", ["span", {class: "token punctuation"}, "..."]],
            ]],

            ["h3", {id: "stop-processes", tabindex: "-1"}, ["a", {href: "#stop-processes", "data-id": "stop-processes", class: "anchor"}, ["span", {}, "Stop processes"]]],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              "pm stop ", ["span", {class: "token punctuation"}, "["], "ID/NAME/TAG", ["span", {class: "token punctuation"}, "]"], ["span", {class: "token punctuation"}, "..."], "\n",
              "", "\n",
              ["span", {class: "token comment"}, "# e.g. stop all added processes (all processes has tag `all` by default)"], "\n",
              "pm stop all",
            ]],
            ["h3", {id: "delete-processes", tabindex: "-1"}, ["a", {href: "#delete-processes", "data-id": "delete-processes", class: "anchor"}, ["span", {}, "Delete processes"]]],
            ["p", {}, "When deleting process, they are first stopped, then removed from", code("pm"), "."],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              "pm delete ", ["span", {class: "token punctuation"}, "["], "ID/NAME/TAG", ["span", {class: "token punctuation"}, "]"], ["span", {class: "token punctuation"}, "..."], "\n",
              "", "\n",
              ["span", {class: "token comment"}, "# e.g. delete all processes"], "\n",
              "pm delete all",
            ]],
            ["h2", {id: "process-state-diagram", tabindex: "-1"}, ["a", {href: "#process-state-diagram", "data-id": "process-state-diagram", class: "anchor"}, ["span", {}, "Process state diagram"]]],
            ...
            ["h2", {id: "development", tabindex: "-1"}, ["a", {href: "#development", "data-id": "development", class: "anchor"}, ["span", {}, "Development"]]],
              ...
              ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
                ["span", {class: "token environment constant"}, "$HOME"], "/.pm/", "\n",
                "├──config.json ", ["span", {class: "token comment"}, "# pm config file"], "\n",
                "├──db/ ", ["span", {class: "token comment"}, "# database tables"], "\n",
                "│   └──", ["span", {class: "token operator"}, "&lt;"], "ID", ["span", {class: "token operator"}, "&gt;"], " ", ["span", {class: "token comment"}, "# process info"], "\n",
                "└──logs/ ", ["span", {class: "token comment"}, "# processes logs"], "\n",
                "  ├──", ["span", {class: "token operator"}, "&lt;"], "ID", ["span", {class: "token operator"}, "&gt;"], ".stdout ", ["span", {class: "token comment"}, "# stdout of process with id ID"], "\n",
                "  └──", ["span", {class: "token operator"}, "&lt;"], "ID", ["span", {class: "token operator"}, "&gt;"], ".stderr ", ["span", {class: "token comment"}, "# stderr of process with id ID"],
              ]],

            ["h3", {id: "differences-from-pm2", tabindex: "-1"}, ["a", {href: "#differences-from-pm2", class: "anchor"}, ["span", {}, "Differences from "]], ["a", {href: "https://github.com/Unitech/pm2", target: "_top"}, "pm2"]],
            ["ul", {},
              ["li", {}, code("pm"), "is just a single binary, not dependent on", code("nodejs"), "and bunch of", code("js"), "scripts"],
              ["li", {}, ["a", {href: "https://jsonnet.org/", target: "_top"}, "jsonnet"], " configuration language, back compatible with", code("JSON"), "and allows to thoroughly configure processes, e.g. separate environments without requiring corresponding mechanism in", code("pm"), "(others configuration languages might be added in future such as", code("Procfile"), code("HCL"), "etc.)"],
              ["li", {}, "supports only", code("linux"), "now"],
              ["li", {}, "I can fix problems/add features as I need, independent of whether they work or not in", code("pm2"), "because I don’t know", code("js")],
              ["li", {}, "fast and convenient (I hope so)"],
              ["li", {}, "no specific integrations for", code("js")],
            ],

            ["h3", {id: "release", tabindex: "-1"}, ["a", {href: "#release", class: "anchor"}, ["span", {}, "Release"]]],
            ["p", {}, "On", code("master"), "branch:"],
            ["pre", {"data-lang": "sh", class: "language-sh"}, ["code", {class: "lang-sh language-sh", tabindex: "0"},
              ["span", {class: "token function"}, "git"], " tag v1.2.3", "\n",
              ["span", {class: "token function"}, "git"], " push ", ["span", {class: "token parameter variable"}, "--tags"], "\n",
              "goreleaser release ", ["span", {class: "token parameter variable"}, "--clean"],
            ]],
        ],
      ],
    ],
